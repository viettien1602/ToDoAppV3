    ...
    <Row>
      <Col md="8">
        <h2 data-cy="categoryDetailsHeading">
          <Translate contentKey="toDoAppV3App.category.detail.title">Category</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="categoryName">
              <Translate contentKey="toDoAppV3App.category.categoryName">Category Name</Translate>
            </span>
          </dt>
