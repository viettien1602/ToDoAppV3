...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getDateTime()).isEqualTo(DEFAULT_DATE_TIME);
    ...
    void putNewOrder() throws Exception {
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getDateTime()).isEqualTo(UPDATED_DATE_TIME);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.dateTime(UPDATED_DATE_TIME).deliveryAddress(UPDATED_DELIVERY_ADDRESS).note(UPDATED_NOTE).status(UPDATED_STATUS);
