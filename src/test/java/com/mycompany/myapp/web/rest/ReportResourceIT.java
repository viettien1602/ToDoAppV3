...
class ReportResourceIT {
    ...
    private static final Double DEFAULT_TOTAL_TURNOVER = 1D;
    private static final Double UPDATED_TOTAL_TURNOVER = 2D;
    ...
    public static Report createEntity(EntityManager em) {
        Report report = new Report().reportTime(DEFAULT_REPORT_TIME).totalTurnover(DEFAULT_TOTAL_TURNOVER).status(DEFAULT_STATUS);
        return report;
    }
    ...
    public static Report createUpdatedEntity(EntityManager em) {
        Report report = new Report().reportTime(UPDATED_REPORT_TIME).totalTurnover(UPDATED_TOTAL_TURNOVER).status(UPDATED_STATUS);
        return report;
    }
    ...
    void createReport() throws Exception {
        ...
        assertThat(testReport.getTotalTurnover()).isEqualTo(DEFAULT_TOTAL_TURNOVER);
    ...
    void getAllReports() throws Exception {
        ...
        restReportMockMvc
            ...
            .andExpect(jsonPath("$.[*].totalTurnover").value(hasItem(DEFAULT_TOTAL_TURNOVER.doubleValue())))
    ...
    void getReport() throws Exception {
        ...
        restReportMockMvc
            ...
            .andExpect(jsonPath("$.totalTurnover").value(DEFAULT_TOTAL_TURNOVER.doubleValue()))
    ...
    void putNewReport() throws Exception {
        ...
        updatedReport.reportTime(UPDATED_REPORT_TIME).totalTurnover(UPDATED_TOTAL_TURNOVER).status(UPDATED_STATUS);
        ...
        assertThat(testReport.getTotalTurnover()).isEqualTo(UPDATED_TOTAL_TURNOVER);
    ...
    void partialUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.totalTurnover(UPDATED_TOTAL_TURNOVER).status(UPDATED_STATUS);
    ...
    void fullUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.reportTime(UPDATED_REPORT_TIME).totalTurnover(UPDATED_TOTAL_TURNOVER).status(UPDATED_STATUS);
