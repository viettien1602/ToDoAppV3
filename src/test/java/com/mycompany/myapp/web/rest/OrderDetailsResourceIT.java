...
class OrderDetailsResourceIT {
    ...
    private static final OrderDetailStatus DEFAULT_STATUS = OrderDetailStatus.DONE;
    private static final OrderDetailStatus UPDATED_STATUS = OrderDetailStatus.PENDING_REFUND;
    ...
    public static OrderDetails createEntity(EntityManager em) {
        OrderDetails orderDetails = new OrderDetails().quantity(DEFAULT_QUANTITY).price(DEFAULT_PRICE).status(DEFAULT_STATUS);
        return orderDetails;
    }
    ...
    public static OrderDetails createUpdatedEntity(EntityManager em) {
        OrderDetails orderDetails = new OrderDetails().quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).status(UPDATED_STATUS);
        return orderDetails;
    }
    ...
    void createOrderDetails() throws Exception {
        ...
        assertThat(testOrderDetails.getStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    void putNewOrderDetails() throws Exception {
        ...
        updatedOrderDetails.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).status(UPDATED_STATUS);
        ...
        assertThat(testOrderDetails.getStatus()).isEqualTo(UPDATED_STATUS);
    }
    ...
    void partialUpdateOrderDetailsWithPatch() throws Exception {
        ...
        partialUpdatedOrderDetails.quantity(UPDATED_QUANTITY).status(UPDATED_STATUS);
    ...
    void fullUpdateOrderDetailsWithPatch() throws Exception {
        ...
        partialUpdatedOrderDetails.quantity(UPDATED_QUANTITY).price(UPDATED_PRICE).status(UPDATED_STATUS);
