...
describe('Product e2e test', () => {
  ...
  it('should create an instance of Product', () => {
    ...
    cy.get(`[data-cy="productName"]`).type('Rustic Tasty').should('have.value', 'Rustic Tasty');

    cy.get(`[data-cy="img"]`).type('stable Crest').should('have.value', 'stable Crest');

    cy.get(`[data-cy="price"]`).type('86678').should('have.value', '86678');

    cy.get(`[data-cy="quantity"]`).type('48249').should('have.value', '48249');

    cy.get(`[data-cy="importDate"]`).type('2023-01-24').should('have.value', '2023-01-24');
